...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>MillerAdmin Module - {{ config('app.name', 'Laravel') }}</title>
        ...
        {{-- Vite CSS --}}
        {{-- {{ module_vite('build-milleradmin', 'resources/assets/sass/app.scss') }} --}}
    </head>
    ...
    <body class="bg-slate-50 text-slate-900">
        <header class="bg-white border-b shadow-sm">
            <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
                <div>
                    <h1 class="text-lg font-semibold">Miller Admin Module</h1>
                </div>
        ...
        {{-- Vite JS --}}
        {{-- {{ module_vite('build-milleradmin', 'resources/assets/js/app.js') }} --}}
    </body>
</html>
